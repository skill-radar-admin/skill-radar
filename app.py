...
note_url = "https://note.com/bold_snake7371/n/ncca37cc824ae"
...
# 🔥 リンクバグ撲滅：st.link_buttonを使わず、ピュアなHTMLのaタグでボタンを生成
tweet_text_encoded = quote(tweet_text)
twitter_url = f"[https://twitter.com/intent/tweet?text=](https://twitter.com/intent/tweet?text=){tweet_text_encoded}"
st.markdown(
    f'<a href="{twitter_url}" target="_blank" style="display: inline-block; padding: 0.5rem 1rem; background-color: #1DA1F2; color: white; text-decoration: none; border-radius: 4px; font-weight: bold; margin-bottom: 20px;">𝕏 で戦闘力をシェアする（画像添付がおすすめ！）</a>',
    unsafe_allow_html=True
)
...
neuro_dive_url = "[https://px.a8.net/svt/ejp?a8mat=4AZD87+4ASRLU+47GS+HVFKY](https://px.a8.net/svt/ejp?a8mat=4AZD87+4ASRLU+47GS+HVFKY)"
neuro_dive_html = f'''
...
<div style="text-align: center; margin: 20px 0;">
    ...
    <a href="[https://px.a8.net/svt/ejp?a8mat=4AZBO5+9QODMQ+373C+6B70H](https://px.a8.net/svt/ejp?a8mat=4AZBO5+9QODMQ+373C+6B70H)" rel="nofollow">
    <img border="0" width="300" height="250" alt="" src="[https://www29.a8.net/svt/bgt?aid=260308949589&wid=003&eno=01&mid=s00000014916001060000&mc=1](https://www29.a8.net/svt/bgt?aid=260308949589&wid=003&eno=01&mid=s00000014916001060000&mc=1)"></a>
    <img border="0" width="1" height="1" src="[https://www17.a8.net/0.gif?a8mat=4AZBO5+9QODMQ+373C+6B70H](https://www17.a8.net/0.gif?a8mat=4AZBO5+9QODMQ+373C+6B70H)" alt="">
</div>
'''
st.markdown(shikaku_square_html, unsafe_allow_html=True)

# 🔥 学習・開発環境（PC）セクション バナー完全対応
st.markdown("---")
...
<div style="display: flex; flex-wrap: wrap; justify-content: space-evenly; align-items: center; gap: 20px; margin: 20px 0;">
    <div style="text-align: center;">
        <a href="[https://click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=252926.761&type=4&subid=0](https://click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=252926.761&type=4&subid=0)" target="_blank">
            <IMG alt="HP Directplus -HP公式オンラインストア-" border="0" src="[https://jp.ext.hp.com/content/dam/jp-ext-hp-com/jp/ja/ec/directplus/aff_banner/Weekend_234x60.jpg](https://jp.ext.hp.com/content/dam/jp-ext-hp-com/jp/ja/ec/directplus/aff_banner/Weekend_234x60.jpg)">
        </a>
        <IMG border="0" width="1" height="1" src="[https://ad.linksynergy.com/fs-bin/show?id=yw57HLgzpBw&bids=252926.761&type=4&subid=0](https://ad.linksynergy.com/fs-bin/show?id=yw57HLgzpBw&bids=252926.761&type=4&subid=0)">
    </div>
    <div style="text-align: center;">
        <a href="[https://click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=39250.10000123&type=4&subid=0](https://click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=39250.10000123&type=4&subid=0)" target="_blank">
            <IMG alt="デル株式会社" border="0" src="[https://i.dell.com/images/jp/banners/banners_l/campaign1_400x100.gif](https://i.dell.com/images/jp/banners/banners_l/campaign1_400x100.gif)">
        </a>
        <IMG border="0" width="1" height="1" src="[https://ad.linksynergy.com/fs-bin/show?id=yw57HLgzpBw&bids=39250.10000123&type=4&subid=0](https://ad.linksynergy.com/fs-bin/show?id=yw57HLgzpBw&bids=39250.10000123&type=4&subid=0)">
    </div>
</div>
'''
