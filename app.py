...
# 🔗 修正：自動リンク化防止
twitter_url = "https://" + "[twitter.com/intent/tweet?text=](https://twitter.com/intent/tweet?text=)" + quote(tweet_text)
st.link_button("𝕏 で戦闘力をシェアする（画像添付がおすすめ！）", twitter_url, type="primary")
        ...
        if first_missing.required_qualification_id:
            ...
            if quali:
                if quali.affiliate_link and quali.affiliate_link.startswith("http"):
                    ...
                    amazon_url = "https://" + f"www.amazon.co.jp/s?k={amz_kw}&tag=skillradar-22"
            ...
            if recommended_qual:
                ...
                amazon_url = "https://" + f"www.amazon.co.jp/s?k={amz_kw_cat}&tag=skillradar-22"
...
# 🔗 修正：自動リンク化防止
neuro_dive_url = "https://" + "px.a8.net/svt/ejp?a8mat=4AZD87+4ASRLU+47GS+HVFKY"
neuro_dive_html = f'''
...
# 🔗 修正：自動リンク化防止
amazon_book_url = "https://" + "www.amazon.co.jp/dp/447810946X?tag=skillradar-22"
...
# 🔗 修正：自動リンク化防止
hp_url = "https://" + "[click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=252926.485&type=4&subid=0](https://click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=252926.485&type=4&subid=0)"
dell_url = "https://" + "[click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=39250.10000123&type=4&subid=0](https://click.linksynergy.com/fs-bin/click?id=yw57HLgzpBw&offerid=39250.10000123&type=4&subid=0)"

with col_pc1:
    st.link_button("🚀 HP Directplus 公式ストア 【PR】", hp_url)
with col_pc2:
    st.link_button("💻 デル・テクノロジーズ 公式 【PR】", dell_url)
